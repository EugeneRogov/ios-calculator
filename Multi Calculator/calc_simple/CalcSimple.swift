...
class CalcSimple: UIViewController {
    ...
    fileprivate func initViews() {
        // localisation
        btnSettings.setTitle(NSLocalizedString(StringIDs.btn_action_settings, comment: ""), for: UIControlState.normal)
        btnHistory.setTitle(NSLocalizedString(StringIDs.btn_action_history, comment: ""), for: UIControlState.normal)
